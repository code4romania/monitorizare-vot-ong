...
namespace MonitorizareVot.Domain.Ong.Migrations
{
    ...
    [Migration("20190801055857_AddObserverEmail")]
    partial class AddObserverEmail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.Answer", b =>
                {
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.County", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.FormSection", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.FormVersion", b =>
                {
                    b.Property<string>("Code")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(2);
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.Ngo", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.NgoAdmin", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.Observer", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.Option", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.OptionToQuestion", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.PollingStation", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.PollingStationInfo", b =>
                {
                    b.Property<int>("IdObserver");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.Question", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.RaspunsSectie", b =>
                {
                    b.Property<int>("IdObservator");

                    b.Property<int>("IdSectie");

                    b.Property<DateTime>("DataUltimeiModificari");

                    b.Property<string>("Observator");

                    b.Property<string>("Sectie");

                    b.HasKey("IdObservator", "IdSectie")
                        .HasName("PK_RaspunsSectie");

                    b.ToTable("RaspunsSectie");
                });

            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.StatisticiCompuse", b =>
                {
                    ...
                    b.ToTable("StatisticiCompuse");
                });

            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.StatisticiOptiuni", b =>
                {
                    b.Property<string>("Label")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("StatisticiOptiuni");
                });

            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.StatisticiSimple", b =>
                {
                    b.Property<string>("Label")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("StatisticiSimple");
                });

            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.Answer", b =>
                {
                    b.HasOne("MonitorizareVot.Domain.Ong.Models.Observer", "Observer")
                        .WithMany("Answers")
                        .HasForeignKey("IdObserver")
                        .HasConstraintName("FK_Answer_Observer")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MonitorizareVot.Domain.Ong.Models.OptionToQuestion", "OptionAnswered")
                        .WithMany("Answers")
                        .HasForeignKey("IdOptionToQuestion")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MonitorizareVot.Domain.Ong.Models.PollingStation", "PollingStation")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.NgoAdmin", b =>
                {
                    b.HasOne("MonitorizareVot.Domain.Ong.Models.Ngo", "Ngo")
                        .WithMany("NgoAdmins")
                        .HasForeignKey("IdNgo")
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.Note", b =>
                {
                    ...
                    b.HasOne("MonitorizareVot.Domain.Ong.Models.Question", "Question")
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.OptionToQuestion", b =>
                {
                    b.HasOne("MonitorizareVot.Domain.Ong.Models.Option", "Option")
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.PollingStation", b =>
                {
                    b.HasOne("MonitorizareVot.Domain.Ong.Models.County", "County")
            ...
            modelBuilder.Entity("MonitorizareVot.Domain.Ong.Models.Question", b =>
                {
                    b.HasOne("MonitorizareVot.Domain.Ong.Models.FormSection", "FormSection")
                        .WithMany("Questions")
